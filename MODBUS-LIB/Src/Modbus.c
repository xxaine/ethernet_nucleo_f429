...
const osThreadAttr_t myTaskModbusA_attributesTCP = { .name = "TaskModbusSlave",
		.priority = (osPriority_t) osPriorityNormal, .stack_size = 256 * 6 };
...
static int8_t TCPconnectserver(modbusHandler_t * modH, modbus_t *telegram);
static int8_t TCPgetRxBuffer(modbusHandler_t * modH);
